...
Replaces TF-IDF with graph-based RAG for better semantic search.
Auto-falls back to TF-IDF if LightRAG is not available.
...
# ── Fallback TF-IDF (used when LightRAG not available) ───────────────────
