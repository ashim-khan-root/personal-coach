# Secuview — All Category FAQ Schema (MU Plugin)

## Usage

Save as `secuview-all-category-faq.php` in `/wp-content/mu-plugins/` via FTP/cPanel.
...
1. SFTP/FTP to your WordPress server
2. Navigate to `/wp-content/mu-plugins/` (create folder if it doesn't exist)
3. Upload `secuview-all-category-faq.php`
4. Go to **wp-admin > Plugins** — confirm "Secuview Category FAQ Schema (All Categories)" shows under Must-Use Plugins
5. Clear any caching plugins (WP Rocket, LiteSpeed, etc.)
6. Verify each category page source contains `"@type": "Question"`

## Covers

| Category | URL | # FAQ Items |
|---|---|---|
| Smart Home | `/product-category/smart-home/` | 4 |
| Security Surveillance | `/product-category/security-surveillance/` | 4 |
| Network & Communications | `/product-category/network-communications/` | 4 |
| Audio Products | `/product-category/audio-products/` | 4 |
| Cable | `/product-category/cable/` | 4 |
